...
Welcome to our Restful API project, crafted with Python to elevate your dining experience! This application empowers
customers to seamlessly access personalized recommendations for restaurants, bars, and more. Additionally, users can
effortlessly book reservations using natural language, simplifying the entire process.

In its current iteration (Version 0.0), the API primarily focuses on enabling reservations. Leveraging the power of
FastAPI as the HTTP framework, MongoDB as the database, and OpenAI as the language model for responding to user queries,
this project ensures a robust and efficient solution for easy restaurant bookings. Get ready to revolutionize the way
...
### Related with running this app

1. Ensure you have Docker Desktop installed.

### Related with Whatsapp account setup
...
## Table of Contents
- [Recommender Chatbot](#build-ai-whatsapp-bots-with-pure-python)
  - [Prerequisites](#prerequisites)
    - [Related with this app](#related-with-running-this-app)
    - [Related with Whatsapp account setup](#related-with-whatsapp-account-setup)
...
```
ngrok http 8000 --domain literate-greatly-snail.ngrok-free.app 
```
         ...
         "changes":[
            {
               "value":{
                  ...
                  "metadata":{
                     "display_phone_number":"15550479611",
                     "phone_number_id":"270590009460228"
                  },
                  "contacts":[
                     {
                        "profile":{
                  ...
                  "messages":[
                     {
                        "from":"573163994204",
                        "id":"wamid.HBgMNTczMTYzOTk0MjA0FQIAEhgUM0E5NTMxMEM1RERGOTI3Rjk5M0MA",
                        "timestamp":"1709401021",
                        "text":{
                           "body":"Buenas"
                        },
                        "type":"text"
         ...
         "changes":[
            {
               "value":{
                  ...
                  "statuses":[
                     {
                        "id":"wamid.HBgMNTczMTYzOTk0MjA0FQIAERgSQkIyMjRDNTBCRDcyQkM1NzJCAA==",
                        "status":"sent",
                        "timestamp":"1709775467",
                        "recipient_id":"573163994204",
                        "conversation":{
                           "id":"ac56b082d2bf32ba0dddd21cf8d494b6",
                           "expiration_timestamp":"1709861880",
                           "origin":{
                              "type":"service"
                           }
                        },
